...
<br />
Dentro de las tecnolog&iacute;as usadas para el desarrollo de <span>Horarios</span> se encuentran: <a href="http://www.php.net/" title="PHP: Hypertext Preprocessor" target="_blank">PHP</a>, <a href="http://www.w3.org/Style/CSS/" title="Cascading Style Sheets" target="_blank">CSS</a> y JavaScript a traves de <a href="http://jquery.com/" title="jQuery: The Write Less, Do More, JavaScript Library" target="_blank">JQuery</a>. Apoyado en cada caso con plugins y aportes de webs, blogs y foros dedicadas al desarrollo web.<br />
<br />
Los invito a experimentar una nueva forma de organizar tu tiempo utilizando <span>Horarios</span>. No se olviden que pueden hacerme llegar sus sugerencias, recomendaciones y/o quejas mediante el formulario de <a href="?contact" title="Formulario de Contacto">contacto</a>.<br />
<br />
<div style="text-align: center; font-size: 13px;">"Las estrellas brillan para todos, solo hay que saber mirar."</div>
<br />
<br />
<div style="text-align: right; font-style: italic;">by RubensaiD</div>
</div>';
